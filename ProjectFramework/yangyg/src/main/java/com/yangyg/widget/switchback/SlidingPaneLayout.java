...
package com.yangyg.widget.switchback;
...
public class SlidingPaneLayout extends ViewGroup {
     ...
     * 侧滑关闭页面 X轴的点击区域
     */
    private float DEFAULT_TOUCH_SWITCH_BACK_SIZE = 100f;
    private float mTouchSwitchBackSize = DEFAULT_TOUCH_SWITCH_BACK_SIZE;
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            Log.e(TAG,"-----------是否不能拖动-------->"+mIsUnableToDrag);
    ...
    public float getmTouchSwitchBackSize() {
        return mTouchSwitchBackSize;
    }

    public void setmTouchSwitchBackSize(float mTouchSwitchBackSize) {
        this.mTouchSwitchBackSize = mTouchSwitchBackSize;
    }
}

...
import com.yangyg.adapter.DragGridViewAdapter;
...
public class DragGridView  extends GridView {
    ...
    private int itemNoDrag = -1;//最后一项是否可以拖动
    ...
    /**
     * 设置第几项Item不能拖动
     * @param lastItemIsDrag
     */
    public void setItemNoDrag(int itemNoDrag){
    	this.itemNoDrag = itemNoDrag;
    }
}

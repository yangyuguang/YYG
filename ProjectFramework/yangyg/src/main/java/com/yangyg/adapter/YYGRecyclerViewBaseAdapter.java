 ...
 */
public abstract class YYGRecyclerViewBaseAdapter<T> extends RecyclerView.Adapter<RecyclerViewHoler>{
    ...
    public YYGRecyclerViewBaseAdapter(Context mContext,int layoutId,List<T> mData){

...
public class TestActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.sendHttp).setOnClickListener(new OnClickListener() {
					...
					request.sendRequestJsonParams("tag", "http://abbapi.17yun.com.cn/app/user/login", "post", params, null, new Callback() {
						...
						public void onResponse(Response arg0) throws IOException {
							...
							runOnUiThread(new Runnable() {
								...
								@Override
								public void run() {
									Toast.makeText(TestActivity.this, "请求成功http", Toast.LENGTH_SHORT).show();
								}
							});
						...
						public void onFailure(Request arg0, IOException arg1) {
							...
							runOnUiThread(new Runnable() {
								...
								@Override
								public void run() {
									Toast.makeText(TestActivity.this, "请求错误http", Toast.LENGTH_SHORT).show();
								}
							});
		...
		findViewById(R.id.sendHttps).setOnClickListener(new OnClickListener() {
...
//					String url = "https://kyfw.12306.cn";
							...
							new Callback() {
								...
								public void onResponse(Response arg0) throws IOException {
									...
									runOnUiThread(new Runnable() {
										...
										@Override
										public void run() {
											Toast.makeText(TestActivity.this, "请求成功https", Toast.LENGTH_SHORT).show();
										}
									});
								...
								public void onFailure(Request arg0, IOException arg1) {
									...
									runOnUiThread(new Runnable() {
										...
										@Override
										public void run() {
											Toast.makeText(TestActivity.this, "请求错误https", Toast.LENGTH_SHORT).show();
										}
									});
		...
		findViewById(R.id.uploadOneImage).setOnClickListener(new OnClickListener() {
		...
		findViewById(R.id.uploadMoreImage).setOnClickListener(new OnClickListener() {

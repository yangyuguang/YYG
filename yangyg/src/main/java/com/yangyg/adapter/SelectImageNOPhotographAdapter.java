...
import com.yangyg.http.ExceptionUtils;
...
public class SelectImageNOPhotographAdapter extends YYGBaseAdapter<String> {
	...
	public void getViews(ViewHolder holder, String t, int position) {
		...
		try {
			...
			lp.width = (YYGApplication.getInstance().getDiaplayWidth() - 12) / 3;
			lp.height = (YYGApplication.getInstance().getDiaplayWidth() - 12) / 3;
